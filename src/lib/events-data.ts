...
export const EVENTS: EventInfo[] = [
  ...
  },
  {
    ...
    specs: [
      { label: "Max size", value: "30 × 30 × 30 cm" },
      { label: "Max weight", value: "3 kg" },
      { label: "Sensors", value: "IR array — min 3, max 8" },
      { label: "Controller", value: "Arduino / Raspberry Pi" },
      { label: "Control mode", value: "100% autonomous (no RC)" },
    ],
    rules: [
      "Robot must be 100% autonomous — zero remote control allowed.",
      "Track layout revealed only 15 minutes before the event!",
      "Leaving the line: must self-correct in 5 sec or it is a DNF.",
      "3 attempts allowed; best valid run time counts.",
      "No bot modifications after the first attempt begins.",
      "Touching the bot mid-run = immediate disqualification.",
    ],
    team_roles: [
    ...
    winning: [
      "Lowest completion time (after penalties) wins the event",
      "+2 seconds penalty per track departure (max 3 departures)",
      "Tie-breaker: second-best attempt time",
      "Separate rankings for Junior category and Senior category",
    ],
  },
  {
    slug: "bot-combat",
