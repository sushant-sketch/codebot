...
export const EVENTS: EventInfo[] = [
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Power", value: "Onboard battery only" },
      { label: "Ball", value: "Hollow PVC, 10 cm" },
      { label: "Mechanism", value: "Kicker / dribbler allowed" },
    ],
    rules: [
      "2 bots per team on field; bench substitutions allowed at halftime.",
      "No deliberate ramming of opponent bots — yellow card.",
      "Hands-off rule once kickoff whistle blows.",
      "Goals must cross the white line completely to count.",
      "Senior division requires at least one autonomous bot.",
    ],
    team_roles: [
