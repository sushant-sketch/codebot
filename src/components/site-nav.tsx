                ...
                <nav className="mx-auto max-w-7xl px-5 sm:px-8 h-16 flex items-center justify-between">
                        <Link to="/" className="group flex items-center gap-2.5">
                                  ...
                                  <div className="leading-tight">
                                              <div className="font-display text-[13px] font-black tracking-widest">CODE BOT</div>div>
                                              <div className="text-[9px] tracking-[0.3em] text-[#00C2E0]">CHAMPIONSHIP 2026</div>div>
                                  </div>div>
                        </Link>Link>
          ...
          {open && (
                  <div className="md:hidden border-t border-white/10 bg-[#0B0B14]/95 backdrop-blur-xl">
                            <div className="px-5 py-4 flex flex-col gap-1">
                              {links.map((l) => (
                                  <Link key={l.to} to={l.to} className="py-2.5 text-sm text-white/80 hover:text-[#FF7A2F]">{l.label}</Link>Link>
                                ))}
                                        <Link to="/register" className="mt-2 inline-flex items-center justify-center rounded-full bg-[#FF7A2F] px-4 py-2.5 text-sm font-bold text-black">REGISTER NOW</Link>Link>
                            </div>div>
                  </div>div>
              )}
        </header>header>
