...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Code Bot Championship 2026 · 22 August 2026 · ₹1.5 Lakh prize pool · 6 mega events for Grades III–XII. Robo Race, Robo Soccer, Line Follower, Bot Combat, Drone Racing, Innovation." },
      { property: "og:title", content: "Code Bot Championship 2026 — India's Ultimate Robotics, AI & Coding Battle" },
      { property: "og:description", content: "Code Bot Championship 2026 · 22 August 2026 · ₹1.5 Lakh prize pool · 6 mega events for Grades III–XII. Robo Race, Robo Soccer, Line Follower, Bot Combat, Drone Racing, Innovation." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Code Bot Championship 2026 — India's Ultimate Robotics, AI & Coding Battle" },
      { name: "twitter:description", content: "Code Bot Championship 2026 · 22 August 2026 · ₹1.5 Lakh prize pool · 6 mega events for Grades III–XII. Robo Race, Robo Soccer, Line Follower, Bot Combat, Drone Racing, Innovation." },
